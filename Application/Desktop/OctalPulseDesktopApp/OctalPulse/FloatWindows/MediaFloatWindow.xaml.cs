...
public partial class MediaFloatWindow : Window
{
    private const string PositionKey = "Media";

    private readonly MediaFloatViewModel _viewModel;
    ...
    public MediaFloatWindow(
        MediaFloatViewModel viewModel,
