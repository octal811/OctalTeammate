...
public partial class StopwatchFloatWindow : Window
{
    private const string PositionKey = "Stopwatch";
    ...
    private async void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            // Default: centered horizontally near top of screen
