...
public partial class MajorTasksFloatWindow : Window
{
    private const string PositionKey = "MajorTasks";
    private static readonly int ScreenHeight = (int)SystemParameters.PrimaryScreenHeight;

    private readonly MajorTasksFloatViewModel _viewModel;
    ...
    public MajorTasksFloatWindow(
        MajorTasksFloatViewModel viewModel,
    ...
    {
        // Restore saved position or default to right edge
    ...
    {
        // Keep it below normal app windows
        SendToDesktopLevel();
    }
    ...
    {
        // Intercept real close → just hide
        e.Cancel = true;
        Hide();
    }
