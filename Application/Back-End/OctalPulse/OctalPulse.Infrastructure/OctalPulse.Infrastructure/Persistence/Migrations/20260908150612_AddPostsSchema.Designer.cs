...
namespace OctalPulse.Infrastructure.OctalPulse.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908150612_AddPostsSchema")]
    partial class AddPostsSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OctalPulse.Domain.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OctalPulse.Domain.Entities.PostComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OctalPulse.Domain.Entities.PostReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("OctalPulse.Domain.Entities.Post", b =>
                {
                    b.HasOne("OctalPulse.Domain.Entities.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("OctalPulse.Domain.Entities.PostComment", b =>
                {
                    b.HasOne("OctalPulse.Domain.Entities.PostComment", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentCommentId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("OctalPulse.Domain.Entities.Post", "Post")
                        .WithMany("Comments")
