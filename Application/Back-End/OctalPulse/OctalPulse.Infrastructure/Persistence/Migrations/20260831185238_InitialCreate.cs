        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainRole = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Progress = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ProjectId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrackLeadUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tracks_Users_TrackLeadUserId",
                        column: x => x.TrackLeadUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProjectRoles_ProjectMembers_ProjectMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MajorTasks_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MajorTasks_Users_AssignedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrackMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrackMembers_Tracks_TrackId",
                        column: x => x.TrackId,
                        principalTable: "Tracks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TrackMembers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MajorTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_MajorTasks_MajorTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "int", nullable: false),
                    CompletedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MajorTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignedUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MinorTasks_Users_AssignedUserId",
                        column: x => x.AssignedUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MajorTasks_AssignedUserId",
                table: "MajorTasks",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MajorTasks_TrackId_Order",
                table: "MajorTasks",
                columns: new[] { "TrackId", "Order" });

            migrationBuilder.CreateIndex(
                name: "IX_MinorTasks_AssignedUserId",
                table: "MinorTasks",
                column: "AssignedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MinorTasks_MajorTaskId_Order",
                table: "MinorTasks",
                columns: new[] { "MajorTaskId", "Order" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackMembers_TrackId_UserId",
                table: "TrackMembers",
                columns: new[] { "TrackId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrackMembers_UserId",
                table: "TrackMembers",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tracks_TrackLeadUserId",
                table: "Tracks",
                column: "TrackLeadUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProjectRoles_ProjectMemberId",
