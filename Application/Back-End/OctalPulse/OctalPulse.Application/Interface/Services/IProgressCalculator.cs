...
public interface IProgressCalculator
{
    ...
    Task<int> GetMajorTaskProgressAsync(Guid majorTaskId, CancellationToken cancellationToken = default);
    ...
    Task<IReadOnlyDictionary<Guid, int>> GetTracksProgressAsync(
        ...
        CancellationToken cancellationToken = default);
    Task<IReadOnlyDictionary<Guid, int>> GetMajorTasksProgressAsync(
